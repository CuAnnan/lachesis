...
const houses = ["Aesin", "Ailil", "Balor", "Baumayn", "Danaan", "Daireann", "Dougal", "Eiluned", "Fiona", "Gwydion", "Leanhaun", "Liam", "Scathach", "Varich"];
const seemings = ["Childing", "Wilder", "Grump"];
const kiths=["Boggan", "Clurichaun", "Eshu", "Nockers", "Piskie", "Pooka", "Redcap", "Satyr", "Selkie", "Sidhe (Arcadian)", "Sidhe (Autumn)", "Sluagh", "Trolls"];
